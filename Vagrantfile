...
Vagrant::Config.run do |config|
  ...
  # config.vm.box_url = "http://files.vagrantup.com/lucid32.box" # FIXME - share this vm somewhere
  ...
  config.vm.forward_port 8021, 8021
  ...
  config.vm.forward_port 10203, 10203
  config.vm.forward_port 12020, 12020
  config.vm.forward_port 12060, 12060
  config.vm.forward_port 50010, 50010
  config.vm.forward_port 50020, 50020
